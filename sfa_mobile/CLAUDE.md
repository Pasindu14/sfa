...
| products | Product catalog (no prices — the legacy price columns are unused) |
| pricing | Active pricing structures (price lists) synced for billing; bills record the structure + list price per line |
