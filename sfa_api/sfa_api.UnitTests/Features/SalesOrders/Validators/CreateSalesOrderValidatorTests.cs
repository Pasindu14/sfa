...
namespace sfa_api.UnitTests.Features.SalesOrders.Validators;

public class CreateSalesOrderValidatorTests
{
    private readonly CreateSalesOrderValidator _validator = new();

    private static CreateSalesOrderRequest CreateValidRequest() => new()
    {
        Notes = null,
        Items =
        [
    ...
    [Fact]
    public void Item_DiscountAt0_ShouldPass()
    {
        var request = CreateValidRequest();
