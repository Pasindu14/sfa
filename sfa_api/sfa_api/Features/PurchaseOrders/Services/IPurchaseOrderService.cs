...
public interface IPurchaseOrderService
{
    ...
    Task<PurchaseOrderListDto> GetAllAsync(int page, int pageSize, string? search, PurchaseOrderStatus? status, DateOnly? fromDate, DateOnly? toDate, int callerId, UserRole callerRole, CancellationToken ct = default);
    ...
    Task<PurchaseOrderStatsDto> GetStatsAsync(int callerId, UserRole callerRole, DateOnly? fromDate, DateOnly? toDate, CancellationToken ct = default);
}
