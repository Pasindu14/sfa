...
public static class PricingStructuresServiceExtensions
{
    public static IServiceCollection AddPricingStructuresFeature(this IServiceCollection services)
    {
        ...
        services.AddScoped<IValidator<DuplicatePricingStructureRequest>, DuplicatePricingStructureValidator>();
        services.AddScoped<IValidator<SetDefaultPricingStructureRequest>, SetDefaultPricingStructureValidator>();
        services.AddScoped<IValidator<BulkUpsertPricingStructureItemsRequest>, BulkUpsertPricingStructureItemsValidator>();
        return services;
    }
}
