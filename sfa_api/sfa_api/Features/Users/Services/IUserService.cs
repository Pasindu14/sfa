...
public interface IUserService
{
    ...
    Task<UserListDto> GetAllUsersAsync(int page, int pageSize, string? search = null, string? role = null, bool? isActive = null, CancellationToken ct = default);
    ...
    Task ResetDeviceIdAsync(int userId, int? callerId, CancellationToken ct = default);
