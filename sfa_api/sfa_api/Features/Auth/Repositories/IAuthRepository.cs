...
public interface IAuthRepository
{
    ...
    /// <summary>Most recently issued token in a family — used to tell a concurrent refresh apart from token theft.</summary>
    Task<RefreshToken?> GetLatestTokenInFamilyAsync(Guid familyId, CancellationToken ct = default);
