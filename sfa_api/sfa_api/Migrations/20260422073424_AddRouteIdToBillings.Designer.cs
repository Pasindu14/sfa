...
namespace sfa_api.Migrations
{
    ...
    [Migration("20260422073424_AddRouteIdToBillings")]
    partial class AddRouteIdToBillings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("sfa_api.Features.Billings.Entities.Billing", b =>
                {
                    ...
                    b.Property<int?>("OriginalBillingId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("sfa_api.Features.Billings.Entities.Billing", b =>
                {
                    ...
                    b.HasOne("sfa_api.Features.Billings.Entities.Billing", "OriginalBilling")
                        .WithMany()
                        .HasForeignKey("OriginalBillingId")
                        .OnDelete(DeleteBehavior.SetNull);
