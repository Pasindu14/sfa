...
namespace sfa_api.Migrations
{
    ...
    [Migration("20260923075918_AddStockActivityLogIndexes")]
    partial class AddStockActivityLogIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("sfa_api.Features.Billings.Entities.Billing", b =>
                {
                    ...
                    b.Property<string>("ClientBillId")
                        .HasMaxLength(64)
                    ...
                    b.Property<double?>("DistanceFromOutletMeters")
                        .HasColumnType("double precision");

                    b.Property<int>("DistributorId")
                        .HasColumnType("integer");

                    b.Property<decimal>("DistributorReturnValue")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18,2)")
                        .HasDefaultValue(0m);
                    ...
                    b.HasIndex("ClientBillId")
                        .IsUnique()
                        .HasFilter("\"ClientBillId\" IS NOT NULL");
                    ...
                    b.HasIndex("BillingDate", "DistributorStatus")
                        .HasFilter("\"IsDeleted\" = false");

                    b.HasIndex("DistributorId", "BillingDate");

                    b.HasIndex("DivisionId", "BillingDate");
            ...
            modelBuilder.Entity("sfa_api.Features.Billings.Entities.BillingAdjustment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("BillingId", "AdjustedAt");

                    b.ToTable("BillingAdjustments");
                });

            modelBuilder.Entity("sfa_api.Features.Billings.Entities.BillingAdjustmentLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("BillingAdjustmentId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("BillingAdjustmentId");

                    b.ToTable("BillingAdjustmentLines");
                });
            ...
            modelBuilder.Entity("sfa_api.Features.Billings.Entities.BillingItem", b =>
                {
                    ...
                    b.Property<int?>("SourceBillingItemId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("SourceBillingItemId");
            ...
            modelBuilder.Entity("sfa_api.Features.GeoConsistency.Entities.GeoConsistencyFlag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("sfa_api.Features.GeoConsistency.Entities.GeoConsistencyRun", b =>
                {
                    ...
                    b.ToTable("GeoConsistencyRuns");
                });

            modelBuilder.Entity("sfa_api.Features.LocationPings.Entities.RepLocationPing", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("sfa_api.Features.NotBillings.Entities.NotBilling", b =>
                {
                    ...
                    b.HasIndex("SalesRepId", "OutletId", "NotBillingDate")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false");
            ...
            modelBuilder.Entity("sfa_api.Features.Stock.Entities.StockAdjustment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("sfa_api.Features.Stock.Entities.StockAdjustmentLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("sfa_api.Features.Stock.Entities.StockReconciliationFlag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("sfa_api.Features.Stock.Entities.StockReconciliationRun", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("StockReconciliationRuns");
                });
            ...
            modelBuilder.Entity("sfa_api.Features.Stock.Entities.StockTransaction", b =>
                {
                    ...
                    b.HasIndex("TransactedBy", "TransactedAt", "Id")
            ...
            modelBuilder.Entity("sfa_api.Features.Stock.Entities.StockTransfer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("SourceDistributorId")
                        .HasColumnType("integer");

                    b.Property<int>("TargetDistributorId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("SourceDistributorId");

                    b.HasIndex("TargetDistributorId");
            ...
            modelBuilder.Entity("sfa_api.Features.Stock.Entities.StockTransferLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("sfa_api.Features.Users.Entities.User", b =>
                {
                    ...
                    b.HasIndex("Imei")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false AND \"Imei\" IS NOT NULL");
            ...
            modelBuilder.Entity("sfa_api.Features.Billings.Entities.BillingAdjustment", b =>
                {
                    b.HasOne("sfa_api.Features.Users.Entities.User", "AdjustedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("sfa_api.Features.Billings.Entities.BillingAdjustmentLine", b =>
                {
                    b.HasOne("sfa_api.Features.Billings.Entities.BillingAdjustment", "BillingAdjustment")
                        .WithMany("Lines")
                        .HasForeignKey("BillingAdjustmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BillingAdjustment");
                });
            ...
            modelBuilder.Entity("sfa_api.Features.Billings.Entities.BillingItem", b =>
                {
                    ...
                    b.HasOne("sfa_api.Features.Billings.Entities.BillingItem", "SourceBillingItem")
                        .WithMany()
                        .HasForeignKey("SourceBillingItemId")
                    ...
                    b.Navigation("SourceBillingItem");
                });
            ...
            modelBuilder.Entity("sfa_api.Features.GeoConsistency.Entities.GeoConsistencyFlag", b =>
                {
                    b.HasOne("sfa_api.Features.GeoConsistency.Entities.GeoConsistencyRun", "Run")
                        .WithMany("Flags")
                        .HasForeignKey("RunId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("sfa_api.Features.LocationPings.Entities.RepLocationPing", b =>
                {
                    b.HasOne("sfa_api.Features.Users.Entities.User", "Rep")
                        .WithMany()
                        .HasForeignKey("RepId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("sfa_api.Features.Stock.Entities.StockAdjustmentLine", b =>
                {
                    ...
                    b.HasOne("sfa_api.Features.Stock.Entities.StockAdjustment", "StockAdjustment")
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("sfa_api.Features.Stock.Entities.StockReconciliationFlag", b =>
                {
                    b.HasOne("sfa_api.Features.Stock.Entities.StockReconciliationRun", "Run")
                        .WithMany("Flags")
                        .HasForeignKey("RunId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("sfa_api.Features.Stock.Entities.StockTransfer", b =>
                {
                    b.HasOne("sfa_api.Features.Distributors.Entities.Distributor", "SourceDistributor")
                        .WithMany()
                        .HasForeignKey("SourceDistributorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("sfa_api.Features.Distributors.Entities.Distributor", "TargetDistributor")
                        .WithMany()
                        .HasForeignKey("TargetDistributorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("sfa_api.Features.Users.Entities.User", "TransferredByUser")
                        .WithMany()
                        .HasForeignKey("TransferredBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("SourceDistributor");

                    b.Navigation("TargetDistributor");
            ...
            modelBuilder.Entity("sfa_api.Features.Stock.Entities.StockTransferLine", b =>
                {
                    ...
                    b.HasOne("sfa_api.Features.Stock.Entities.StockTransfer", "StockTransfer")
                        .WithMany("Lines")
