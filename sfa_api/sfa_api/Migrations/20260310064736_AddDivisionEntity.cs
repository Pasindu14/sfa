        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Divisions_Areas_AreaId",
                        column: x => x.AreaId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Divisions_Territories_TerritoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Divisions_AreaId",
                table: "Divisions",
                column: "AreaId");

            migrationBuilder.CreateIndex(
                name: "IX_Divisions_Name_TerritoryId",
                table: "Divisions",
                columns: new[] { "Name", "TerritoryId" },
                unique: true);
