...
export default {
  ...
  callbacks: {
    authorized({ auth, request: { nextUrl } }) {
      ...
      if (path.startsWith("/distributor-dashboard") || path.startsWith("/distributor-stock") || path.startsWith("/distributor-billings") || path.startsWith("/distributor-grns") || path.startsWith("/distributor-purchase-orders")) {
        if (userRole?.toLowerCase() !== "distributor") {
