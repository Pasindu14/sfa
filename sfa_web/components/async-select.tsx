...
export interface AsyncSelectProps<T> {
  ...
  clearable?: boolean;
  /** Pre-populate the selected option (e.g. for edit forms where the value is already known) */
...
export function AsyncSelect<T>({
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent style={{ width: "var(--radix-popover-trigger-width)" }} className={cn("p-0", className)}>
