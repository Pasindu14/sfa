/**
 * Migration script: SQL Server AreaMaster → PostgreSQL Areas
 *
 * SQL Server source columns:
 ...
 *
 * Run: npx tsx scripts/migrate-areas.ts
 */
...
function buildBatchInsert(batch: MappedRow[]): { text: string; values: unknown[] } {
  ...
  const text = `
    INSERT INTO "Areas" ("Id", "Name", "RegionId", "IsActive", "CreatedAt", "UpdatedAt", "CreatedBy", "UpdatedBy")
