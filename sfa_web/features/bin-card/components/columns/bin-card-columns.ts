...
export const BIN_CARD_COLUMNS: BinCardColumn[] = [
  ...
  { key: 'transferIn',        header: 'Transfer In',         get: (r) => r.transferIn,        getTotal: (t) => t.transferIn,        align: 'right' },
  ...
  { key: 'transferOut',       header: 'Transfer Out',        get: (r) => r.transferOut,       getTotal: (t) => t.transferOut,       align: 'right' },
