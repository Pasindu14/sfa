...
interface UserGeoAssignmentDialogState {
...
export const useUserGeoAssignmentDialogStore = create<UserGeoAssignmentDialogState>()(
  devtools(
    (set) => ({
      isCreateOpen: false,
      isEditOpen: false,
    ...
    { name: 'UserGeoAssignmentDialogStore' },
  ),
)
