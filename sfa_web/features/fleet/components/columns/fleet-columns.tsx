...
import type { FleetDto } from '../types/fleet.types'

export interface FleetColumnActions {
  openEdit: (id: number) => void
  openActivate: (id: number) => void
  openDeactivate: (id: number) => void
}

export function getFleetColumns(actions: FleetColumnActions): ColumnDef<FleetDto>[] {
